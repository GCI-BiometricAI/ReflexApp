...
net = cv.dnn.readNetFromTensorflow("../GCIProject/GCIProject/pages/humanPose/graph_opt.pb")
thr = 0.2
...
image_path = '../GCIProject/GCIProject/pages/humanPose/Pics/Person.jpeg'  # Adjust the path accordingly if the image is in a different folder
...
# Example usage
clear_csv('../GCIProject/GCIProject/data.csv')
write_to_csv('../GCIProject/GCIProject/data.csv', "RightShoulder", Rshoulder_x, Rshoulder_y)
write_to_csv('../GCIProject/GCIProject/data.csv', "LeftShoulder", Lshoulder_x, Lshoulder_y)
if points[BODY_PARTS["LHip"]] is not None:
  write_to_csv('../GCIProject/GCIProject/data.csv', "RightHip", RHip_x, RHip_y)
  write_to_csv('../GCIProject/GCIProject/data.csv', "LeftHip", LHip_x, LHip_y)
