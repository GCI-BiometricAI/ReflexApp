...
class CamState(rx.State):
    ...
    def handle_screenshot(self, img_data_uri: str):
        ...
        with urlopen(img_data_uri) as img:
            ...
            self.last_screenshot.save("../GCIProject/GCIProject/pages/humanPose/Pics/"+filename, "JPEG")  # type: ignore
            
            subprocess.run(["../GCIProject/.venv/bin/python3", "../GCIProject/GCIProject/pages/humanPose/lahackstest.py"])
