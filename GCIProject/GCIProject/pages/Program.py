from GCIProject.templates import ThemeState, template
...
GOOGLE_API_KEY = "AIzaSyA6x2GXkxCgi1mWZn_7eXm9DHXkZK1DZ5c"
...
class AIState(rx.State):
    ...
    def Generate_Prompt(self):
        ...
        with open('../GCIProject/GCIProject/data.json', 'r') as file:
            data = json.load(file)
...
"""
        ...
        with open('../GCIProject/GCIProject/output.json', 'w') as f:
